...
// The same subscriber can be used on multiple topics. In the other hand, in order to increase Broker's throughput, is
// highly recommended designing each Broker in such a way that handling of each message is asynchronously, in a
// separated goroutine.
